...
const PageHeader = ({headerInfo}) => {
    ...
    return (
        <div>
            <section className='relative min-h-[400px] pt-10 lg:py-32  flex items-center justify-start bg-center bg-no-repeat bg-cover' style={{backgroundImage:`url(${img?img:img1})`}}>
