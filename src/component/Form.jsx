      ...
      >
        <div className="space-y-4">
          <div>
            ...
            <PhoneInput defaultCountry="BD" placeholder="Enter phone number" international value={value} onChange={setValue} className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:outline-none focus-visible:outline-none input-phone-number" />
        ...
        <div className="space-y-2">
          ...
          {myForm.footerText && (
            <p className="p-4 text-sm text-center dark:text-gray-400">
              {myForm.footerText}
              <Link
                to={`/${myForm.linkedText === "Sign in" ? "login" : "signup"}`}
